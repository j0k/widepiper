...
Мини‑схема того, как это всё связано:

```mermaid
flowchart LR
    U[👤 Пользователь] -->|браузер / Mini App| N[🧊 Nginx<br/>tg.ma8ka.com]
    N --> W[🧠 Django webapp<br/>webapp/core/*]
    W --> B[📈 Bet manager<br/>bet_manager/__main__.py]
    W --> D[💳 Deposit monitor<br/>core/deposit_monitor.py]
```
